  ...
  PROCESS(disp_ena, row, column)
	...
	IF (disp_ena = '1') THEN 
		...
		WHEN cero =>
			...
			ELSIF ((row > 210 and row <240) and (column>100 and column<110)) THEN --2
					red <= (OTHERS => '0');
					green <= (OTHERS => '1');
					blue <= (OTHERS => '0');
		...
		WHEN dos =>
			...
			ELSIF ((row > 250 and row <280) and (column>100 and column<110)) THEN --6
					red <= (OTHERS => '0');
					green <= (OTHERS => '1');
					blue <= (OTHERS => '0');
			...
			ELSIF ((row > 210 and row <240) and (column>140 and column<150)) THEN --2
					red <= (OTHERS => '0');
					green <= (OTHERS => '1');
					blue <= (OTHERS => '1');
		...
		-- CUATRO --
		WHEN cuatro =>
			IF ((row > 210 and row <240) and (column>100 and column<110)) THEN --1
					red <= (OTHERS => '1');
					green <= (OTHERS => '0');
					blue <= (OTHERS => '0');
		...
		WHEN cinco =>
			...
			ELSIF ((row > 210 and row <240) and (column>100 and column<110)) THEN --1
					red <= (OTHERS => '0');
					green <= (OTHERS => '1');
					blue <= (OTHERS => '0');
			...
			ELSIF ((row > 250 and row <280) and (column>140 and column<150)) THEN --7
					red <= (OTHERS => '0');
					green <= (OTHERS => '1');
					blue <= (OTHERS => '1');
		...
		WHEN seis =>
			...
			ELSIF ((row > 250 and row <280) and (column>100 and column<110)) THEN --2
					red <= (OTHERS => '1');
					green <= (OTHERS => '0');
					blue <= (OTHERS => '0');
		...
		-- SIETE --
		WHEN siete =>
			IF ((row > 200 and row <210) and (column>110 and column<140)) THEN --3
					red <= (OTHERS => '1');
					green <= (OTHERS => '0');
					blue <= (OTHERS => '1');
			
			ELSIF ((row > 210 and row <240) and (column>140 and column<150)) THEN --6
					red <= (OTHERS => '0');
					green <= (OTHERS => '1');
					blue <= (OTHERS => '0');
		...
		WHEN ocho =>
			...
			ELSIF ((row > 250 and row <280) and (column>140 and column<150)) THEN --2
					red <= (OTHERS => '0');
					green <= (OTHERS => '1');
					blue <= (OTHERS => '0');
